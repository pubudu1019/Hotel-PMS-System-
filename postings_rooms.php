...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_posting'])) {
    ...
    if ($res_id > 0 && $amount > 0 && !empty($description)) {
        ...
        if ($conn->query($insert)) {
            $message = "Room posting posted successfully!";
            $msg_type = "success";
        } else {
    ...
    header("Location: postings_rooms.php?res_id=$res_id&msg=" . urlencode($message) . "&type=$msg_type");
    exit();
}
...
<head>
    <meta charset="UTF-8">
    <title>Postings - Rooms - Araliya PMS</title>
...
<div class="page-container">
    <div class="page-header">
        <h4><i class="fas fa-bed"></i> Postings - Rooms</h4>
    ...
    <form method="GET" action="" class="row g-3 align-items-end mb-4">
        ...
        <div class="col-md-2">
            <a href="postings_rooms.php" class="btn btn-outline-secondary w-100">Clear</a>
        </div>
    </form>

    <?php if($selected_res_id > 0): ?>
        <div class="card mt-3">
            <div class="card-header bg-light"><strong><i class="fas fa-plus-circle me-2"></i>Post Room Charge</strong></div>
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="description" class="form-control" placeholder="e.g. Room Charge, Extra Bed" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn-submit w-100"><i class="fas fa-check-circle me-2"></i>Post Charge</button>
                </form>
            </div>
        </div>
    <?php elseif($selected_res_id == 0): ?>
        <div class="text-center text-muted py-4">
            ...
            <h5>Select a guest to post room charges</h5>
        </div>
    <?php endif; ?>
</div>
</body>
